...
/// active : 23240029
/// critical : 35837
/// casesPerOneMillion : 89748
/// deathsPerOneMillion : 892.5
/// tests : 7009772947
/// testsPerOneMillion : 882294.55
/// population : 7944935131
/// oneCasePerPeople : 0
/// oneDeathPerPeople : 0
/// oneTestPerPeople : 0
/// activePerOneMillion : 2925.14
/// recoveredPerOneMillion : 84251.11
...
class WorldCasesModel {
  ...
  WorldCasesModel.fromJson(dynamic json) {
...
WorldCasesModel copyWith({  num? updated,
  num? cases,
  num? todayCases,
  num? deaths,
  num? todayDeaths,
  ...
  num? criticalPerOneMillion,
  num? affectedCountries,
}) => WorldCasesModel(  updated: updated ?? _updated,
  cases: cases ?? _cases,
